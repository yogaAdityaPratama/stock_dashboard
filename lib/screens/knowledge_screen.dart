  ...
  final List<Map<String, dynamic>> terms = [
    {
      ...
      'dominance': 0.95,
      'desc':
          'Morgan Stanley Capital International. Indeks acuan global bagi manajer investasi asing. Saham yang masuk MSCI biasanya akan mendapatkan inflow masif dari Big Money.',
    },
    {
      'name': 'Big Whale',
      'code': 'WHALE',
      ...
      'dominance': 0.88,
      'desc':
          'Entitas atau individu dengan kekuatan dana luar biasa yang mampu menggerakkan arah market secara signifikan. Sekali beli, volume akan meledak.',
    },
    {
      'name': 'Megalodon',
      'code': 'MEGA',
      ...
      'dominance': 0.98,
      'desc':
          'Level tertinggi dari Big Money. Biasanya merujuk pada kolaborasi antar institusi raksasa atau SWF (Sovereign Wealth Fund) yang masuk ke sebuah emiten.',
    },
    {
      'name': 'Accumulation',
      'code': 'ACC',
      ...
      'flag': '📈',
      'desc':
          'Kondisi menarik di mana Broker Besar (Big Money) membeli saham dalam volume besar secara konsisten tanpa menaikkan harga secara signifikan (markup).',
    },
    {
      'name': 'Distribution',
      'code': 'DIST',
      ...
      'flag': '📉',
      'desc':
          'Kebalikan dari akumulasi, di mana Big Money menjual kepemilikan saham mereka kepada investor retail.',
    },
    {
      'name': 'Smart Money',
      'code': 'SMF',
      ...
      'flag': '🧠',
      'desc':
          'Aliran dana dari institusi besar atau investor asing yang biasanya memiliki informasi lebih awal tentang pergerakan harga.',
    },
    {
      'name': 'Wash Trade',
      'code': 'WASH',
      ...
      'flag': '🧼',
      'desc':
          'Aksi jual-beli yang dilakukan oleh pihak yang sama untuk menciptakan volume palsu atau menjaga harga.',
    },
    {
      'name': 'FOMO',
      'code': 'FOMO',
      ...
      'flag': '😱',
      'desc':
          'Kondisi psikologis di mana investor takut kehilangan momentum saat harga naik tinggi, berujung beli di pucuk.',
    },
  ];
